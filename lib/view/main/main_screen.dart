...
import 'package:bubbly/view/chat/chat_screen1.dart';
...
class MainScreen extends StatefulWidget {
  ...
  const MainScreen({Key key, this.chatClient}) : super(key: key);
  @override
  _MainScreenState createState() => _MainScreenState();
}

class _MainScreenState extends State<MainScreen> {
  List<Widget> mListOfWidget;
  ...
  void initState() {
    mListOfWidget = [
      ...
      ChatScreen(
          ...
          SessionManager.streamToken != null
              ? SessionManager.streamToken.toString()
              : ''),
      // NotificationScreen(),
      ProfileScreen(
          0,
    ...
    super.initState();
    initPref();
    print(SessionManager.accessToken.toString());
