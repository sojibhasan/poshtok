...
class DialogLogin extends StatelessWidget {
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                // ),
                Text(
                  'By continuing, you agree to  PoshTok\'s terms of use\nand confirm that you have read our privacy policy.',
                  style: TextStyle(
                    color: colorTextLight,
                    fontSize: 12,
                    fontFamily: fNSfUiLight,
  ...
  void callApiForLogin(User value, int type, BuildContext context) {
    ...
    params[Const.deviceToken] =
        "mobile_token"; //sessionManager.getString(Const.deviceToken) ??
