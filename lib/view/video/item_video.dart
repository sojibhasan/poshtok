...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  VideoPlayerController get _controller => VideoPlayerController.network(
        Const.videoBaseUrl + widget.url,
      ...
      return InkWell(
        onTap: () {
          if (chewieController.isPlaying) {
            setState(() {
              print(Const.itemBaseUrl + widget.url);
              chewieController.pause();
              visible = true;
              // Future.delayed(
