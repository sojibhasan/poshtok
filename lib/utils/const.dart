...
const PrivacyUrl = 'https://poshtok.com/privacy';
...
class Const {
  static final String baseUrl = 'https://api.poshtok.com/api/';

  static final String itemBaseUrl = 'https://s3.amazonaws.com/poshtokstore/';
  static final String videoBaseUrl =
      "https://poshtokstore.s3.ap-southeast-2.amazonaws.com/";

  static final String streamApiKey = '49d4cbuf67hv';
  // static final String streamApiKey = '6ysx7szd7n5b';
  ...
  static final String helpUrl = 'https://poshtok.com/contact';
  static final String privacyUrl = 'https://poshtok.com/privacy';
  static final String termsOfUseUrl = 'https://poshtok.com/terms';
}
